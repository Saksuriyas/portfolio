...
const socialLinks = [
  {
    id: 1,
    title: "Saksuriya S.'s Github Profile",
    link: "https://github.com/Saksuriyas",
    svg: (
      <svg
  ...
  {
    id: 2,
    title: "Saksuriya S.'s LinkedIn Profile",
    link: "https://www.linkedin.com/in/saksuriya-sarasuk-42325639/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 3,
    title: "Check Saksuriya S. on Dev.to",
    link: "https://dev.to/tagingss",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
